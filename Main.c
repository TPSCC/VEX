...
#pragma config(Motor,  port1,           rightBack,     tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port9,          rightFront,    tmotorVex393_HBridge, openLoop)
#pragma config(Motor,  port8,           leftTopLift,      tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port5,           leftBottomLift,     tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           rightTopLift,      tmotorVex393_MC29, openLoop)
